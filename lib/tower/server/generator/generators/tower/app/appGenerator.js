    ...
    return this.inside(this.app.name, '.', function() {
      ...
      this.inside("vendor", function() {
        this.inside("javascripts", function() {
          ...
          this.get("https://raw.github.com/emberjs/starter-kit/master/js/libs/ember-0.9.6.js", "ember.js");
        ...
        return this.inside("stylesheets", function() {
          ...
          this.directory("bootstrap");
          _ref = ["accordion", "alerts", "badges", "bootstrap", "breadcrumbs", "button-groups", "buttons", "carousel", "close", "code", "component-animations", "dropdowns", "forms", "grid", "hero-unit", "labels", "layouts", "mixins", "modals", "navbar", "navs", "pager", "pagination", "popovers", "progress-bars", "reset", "responsive", "scaffolding", "sprites", "tables", "thumbnails", "tooltip", "type", "utilities", "variables", "wells"];
          _results = [];
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            stylesheet = _ref[_i];
